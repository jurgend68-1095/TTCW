...
class OCUC_Loader {
	...
	public function define_constants() {
		...
		define('ONECOM_UC_VERSION', '2.2.8');
	...
	public function ocuc_wp_load_textdomain() {
		...
		if ( $current_locale === 'fi' ) {
			$result = load_textdomain(ONECOM_UC_TEXT_DOMAIN, ONECOM_UC_PLUGIN_URL . '/languages/onecom-uc-fi_FI.mo');
		} else if ( $current_locale === 'nb_NO' ) {
			$result = load_textdomain(ONECOM_UC_TEXT_DOMAIN, ONECOM_UC_PLUGIN_URL . '/languages/onecom-uc-no_NO.mo');
			...
			$result = load_textdomain(ONECOM_UC_TEXT_DOMAIN, ONECOM_UC_PLUGIN_URL . '/languages/onecom-uc-en_GB.mo');
		}
