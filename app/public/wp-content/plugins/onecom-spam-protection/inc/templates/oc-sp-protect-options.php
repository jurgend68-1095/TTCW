	...
	<form id="sp-settings" class="sp-protect-options" method="post" name="sp-protect-options">
		...
		<label class="sp-sub-points"><?php _e('Maximum no of failed login attempts', OC_SP_TEXTDOMAIN) ?>: <input
					type="number" required class="oc_max_login_val" name="oc_max_login_val"
					value="<?php echo $oc_max_login_val ?>" min="1" max="10"></label>
		<label class="sp-sub-points last-form-item"><?php _e('Time for which user will be temporarily blocked(in seconds)', OC_SP_TEXTDOMAIN) ?>
			: <input
