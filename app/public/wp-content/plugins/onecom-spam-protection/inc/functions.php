...
function oc_spam_protection_activate() {
	...
	} elseif ( isset($sp_options['exploit-urls']) && $sp_options['sp_protection_version'] != ONECOM_SP_VERSION ) {
	...
	(class_exists('OCPushStats') ? \OCPushStats::push_stats_event_themes_and_plugins('activate', 'plugin', ONECOM_SP_PLUGIN_SLUG, $referrer) : '');
