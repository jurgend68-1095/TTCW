...
<div class="avantex-extras-page shadow-lg bg-light h-100 p-3 me-3">
	<h1>Avantex Extras</h1>
	<p>Thanks for choosing Avantex. Please have a look at our various builds!</p>
</div>

<div class="container-full me-3">
				...
				<div class="col">
					...
					<img class="card-img-top" src="<?php echo esc_url( $src ); ?>" alt="<?php echo esc_attr( $alt ); ?>">
						<div class="card-body">
							...
							<p class="card-text avantex-card-formating"><?php echo esc_html( $extras_short_description ); ?></p>
							<p class="card-text avantex-card-formating"><b>Total Downloads :</b> <?php echo esc_html( number_format_i18n( $extras_downloaded ) ); ?>+</p>
							<p class="card-text avantex-card-formating"><b>Author :</b> <?php echo wp_kses_post( $extras_author, ); ?></p>
						</div>
						<?php
						$allowed_tags = array(
							'button' => array(
					...
					<div class="card shadow-lg bg-light h-100">
						...
						<div class="card-body">
							...
							<?php if ( ! empty( $thm_parent ) ) { ?>
								<p class="card-text avantex-card-formating"><b>Child theme of : </b><?php echo esc_html( $thm_parent['name'] ); ?></p>
							<?php } ?>
							<?php echo wp_kses_post( $star_rating_html ); ?>
							<p class="card-text avantex-card-formating"><b>Total Downloads : </b><?php echo esc_html( number_format_i18n( $thm_downloaded ) ); ?>+</p>
							<p class="card-text avantex-card-formating"><b>Author :</b> <a href="<?php echo esc_url( $thm_author['profile'] ); ?>" ><?php echo esc_html( $thm_author['display_name'], ); ?></a> </p>
							<p class="card-text avantex-card-formating"><b>Author Web:</b> <a href="<?php echo esc_url( $thm_author['author_url'] ); ?>" ><?php echo esc_html( $thm_author['author_url'], ); ?></a> </p>
						</div>
								<?php
						...
						<p class="card-text text-center btn-formatting mt-1">
							...
							?>
							<a href="<?php echo esc_url( $thm_demo_link ); ?>" type="button" class="btn avantex-dm-btn-clr" target="_blank" >Pro Demo</a>
							<a href="<?php echo esc_url( $thm_buy_link ); ?>" type="button" class="btn avantex-buy-btn-clr" target="_blank" >Buy Now</a>
						</p>
						<div class="card-footer">
